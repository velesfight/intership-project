        ...
        <div className={styles.content}>
          ...
          <div className={styles.container}>
            <Text color='primary' className={styles.recover}>
              <Link to={AppRoute.Recover}>{t('text.forgotPassword')}</Link>
            </Text>
          </div>
          ...
          <div className={styles.footer}>
            <Text color='content2'>{t('text.noAccount')}</Text>
            <Text color='primary' className={styles.join}>
              <Link to={AppRoute.SignUp}> {t('text.signUp')}</Link>
            </Text>
          </div>
        </div>
      </div>
